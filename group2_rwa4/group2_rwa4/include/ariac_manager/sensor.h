...
//    ros::Subscriber quality_control_camera_subscriber_;
    ...
    camera4_part_list_, camera5_part_list_, camera6_part_list_;
    std::vector<std::string> order_part_type_;
    ...
    camera4_frame_counter_, camera5_frame_counter_, camera6_frame_counter_,
    break_beam_counter_,prev1,prev2,prev3,prev4,prev5,prev6,f;

    // AriacOrderManager part_info_;
};
